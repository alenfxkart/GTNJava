...
public class ExcelDecryptReadingNew {
    public static void main(String args[]) throws IOException {
        ...
        try {
            File file = new File("F:\\Projects\\Java\\GTNWebCall\\GTNDATAOP.xlsx");   //creating a new file instance
...
//                            }
            ...
            try {
                FileOutputStream out = new FileOutputStream(new File("GTNDATAOP_Error2_Decrypt.xlsx"));
                workbook.write(out);
                out.close();
                System.out.println("GTNDATAOP_Error2_Decrypt.xlsx written successfully on disk.");
            }
            catch (Exception e) {
                e.printStackTrace();
            }
