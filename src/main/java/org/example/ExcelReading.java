...
public class ExcelReading {
    public static void main(String args[]) throws IOException {
        ...
        try {
            File file = new File("D:\\Projects\\Java\\GTNWebCall\\AUBdata.xlsx");   //creating a new file instance
                ...
                while (cellIterator.hasNext()) {
                    ...
                    switch (cell.getCellType()) {
                            ...
                            if (i == 3 ) {
                                ...
                                if(rowcnt > 0)
                                {
                                    try {
                                        ...
                                        String encyptedPayload = encoder.getDualEncrypted(toEncrypt);
                        ...
                        case Cell.CELL_TYPE_NUMERIC:    //field that represents number cell type
                            ...
                            if (i == 1) {
                                xchange = String.valueOf((int) cell.getNumericCellValue());
                                System.out.print(xchange + "\t\t\t");
                            }
                            if (i == 2) {
                                ticker = String.valueOf((int) cell.getNumericCellValue());
                                System.out.print(ticker + "\t\t\t");
                            }
                            if (i == 3 ) {
                                isin = String.valueOf((int) cell.getNumericCellValue());
                                System.out.print(isin + "\t\t\t");
